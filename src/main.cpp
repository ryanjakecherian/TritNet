...
int main() {
 ...
 //========== MAIN PROGRAM ===============
    ...
    //params
    int input_dim = 1024;                  //                              NOTE: MUST BE MULTIPLE OF THE WORD_SIZE (zero-padding functionality not implemented yet)
    int output_dim = 1024;                 //                              NOTE: MUST BE MULTIPLE OF THE WORD_SIZE (zero-padding functionality not implemented yet)
    int depth = 8;                      //number of hidden layers.
    int hidden_layers[depth]={1024,1024,1024,1024,1024,1024,1024,1024};        //dimensions of hidden layers.  NOTE: MUST BE MULTIPLES OF THE WORD_SIZE (zero-padding functionality not implemented yet)
